        ...
        void 0 ===
          (n = function (t) {
            ...
            (e.getRGB = ht(function (t) {
              ...
              !D[o](t.toLowerCase().substring(0, 2)) &&
                "#" != t.charAt() &&
                (t = it(t));
              var r,
                i,
              ...
              At =
                ((e._parseDots = ht(function (t) {
                  ...
                  for (i = 1, n = r.length - 1; i < n; i++)
                    if (!r[i].offset) {
                      for (
                        var o = F(r[i - 1].offset || 0), l = 0, h = i + 1;
                        h < n;
                        h++
                      )
                        if (r[h].offset) {
                ...
                C = function (n, l) {
                  ...
                  if (
                    ...
                    if (
                      ...
                      O.dashstyle = Y[e](l["stroke-dasharray"])
                        ? Y[l["stroke-dasharray"]]
                        : f;
                    }
                    V && u.appendChild(O);
                  }
