...
(function ($) {
  ...
  $.fn.fileinputLocales["he"] = {
    ...
    msgSizeTooSmall:
      'קובץ "{name}" (<b>{size} KB</b>) קטן מדי וחייב להיות גדול מ <b>{minSize} KB</b>.',
    msgSizeTooLarge:
      'קובץ "{name}" (<b>{size} KB</b>) חורג מהגודל המרבי המותר להעלאה של <b>{maxSize} KB</b>.',
    msgFilesTooLess: "עליך לבחור לפחות <b>{n}</b> {files} להעלאה.",
    msgFilesTooMany:
      "מספר הקבצים שנבחרו להעלאה <b>({n})</b> חורג מהמגבלה המרבית המותרת של <b>{m}</b>.",
    ...
    msgInvalidFileExtension:
      'תוסף לא חוקי עבור הקובץ "{name}". רק "{extensions}" קבצים נתמכים.',
    msgFileTypes: {
      image: "תמונה",
      html: "HTML",
      text: "טקסט",
    ...
    msgImageHeightSmall:
      'גובה קובץ התמונה "{name}" חייב להיות לפחות {size} px.',
