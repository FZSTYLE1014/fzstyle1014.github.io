...
(function ($) {
  ...
  $.fn.fileinputLocales["zh-TW"] = {
    ...
    msgSizeTooSmall:
      '檔案 "{name}" (<b>{size} KB</b>) 必須大於限定大小 <b>{minSize} KB</b>.',
    msgSizeTooLarge:
      '檔案 "{name}" (<b>{size} KB</b>) 大小超過上限 <b>{maxSize} KB</b>.',
    msgFilesTooLess: "最少必須選擇 <b>{n}</b> {files} 來上傳. ",
    msgFilesTooMany:
      "上傳的檔案數量 <b>({n})</b> 超過最大檔案上傳限制 <b>{m}</b>.",
    ...
    msgInvalidFileExtension:
      '附檔名錯誤 "{name}". 只能使用 "{extensions}" 的檔案.',
    msgFileTypes: {
      image: "image",
      html: "HTML",
      text: "text",
    ...
    msgProgress:
      "載入第 {index} 個檔案，共 {files} - {name} - {percent}% 成功.",
