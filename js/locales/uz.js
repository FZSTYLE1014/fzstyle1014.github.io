...
(function ($) {
  ...
  $.fn.fileinputLocales.uz = {
    ...
    msgSizeTooSmall:
      'Siz tanlagan fayl hajmi: "{name}" (<b>{size} KB</b>). Tanlangan fayl hajmi <b>{minSize} KB</b> dan katta bo‘lishi lozim. Ko‘rsatilgan hajmdan kattaroq fayl yuklashga urinib ko‘ring',
    msgSizeTooLarge:
      '"{name}" fayl (<b>{size} KB</b>) ruxsat etilgan maksimal yuklash hajm: <b>{maxSize} KB</b> dan katta. Kichikroq fayl yuklashga urinib ko‘ring!',
    msgFilesTooLess:
      "Yuklash uchun kamida <b>{n}</b> {files} tanlashingiz kerak. Yuklashga qaytadan urinib ko‘ring!",
    msgFilesTooMany:
      "Siz tanlagan fayllar miqdori : <b>({n})</b>, ruxsat berilgan maksimal miqdor: <b>{m}</b> tadan ortiq. Ko‘rsatilgan miqdordan kamroq fayl tanlab, yuklashga qaytadan urinib ko‘ring!",
    msgTotalFilesTooMany:
      "You can upload a maximum of <b>{m}</b> files (<b>{n}</b> files detected).",
    msgFileNotFound: '"{name}" fayl topilmadi!',
    msgFileSecured:
      '"{name}" faylni o‘qishga xavfsizlik cheklovi ruxsat bermaydi.',
    msgFileNotReadable: '"{name}" fayl o‘qilmaydi.',
    msgFilePreviewAborted:
      '"{name}" Faylni oldindan ko‘rish jarayoni to‘xtatildi.',
    msgFilePreviewError: '"{name}" faylni o‘qish paytida xatolik yuz berdi.',
    msgInvalidFileName:
      '"{name}" fayl nomida noto‘g‘ri yoki qo‘llab quvvatlanmaydigan belgilar mavjud.',
    msgInvalidFileType:
      '"{name}" fayl uchun yaroqsiz tur. Faqat "{types}" fayllari qo‘llab-quvvatlanadi.',
    msgInvalidFileExtension:
      '"{name}" fayl uchun noto‘g‘ri kengaytma. Faqat "{extensions}" fayllari qo‘llab-quvvatlanadi.',
    msgFileTypes: {
      image: "image",
      html: "HTML",
      text: "text",
    ...
    msgProgress:
      "{Files} dan {index}{name} faylini yuklashi  - {percent}% tugallandi.",
    msgSelected: "{n} {files} tanlangan",
    msgFoldersNotAllowed:
      "Faqat tortib qo‘yiladon fayllar! {n} o‘tirilgan tashlangan papka(lar).",
    msgImageWidthSmall:
      '"{name}" fayl kengligi {size} px dan kam bo‘lmasligi lozim.',
    msgImageHeightSmall:
      '"{name}" fayl bo‘yi {size} px dan kam bo‘lmasligi lozim.',
    msgImageWidthLarge:
      '"{name}" fayl kengligi {size} px dan kam bo‘lishi lozim.',
    msgImageHeightLarge:
      '"{name}" fayl bo‘yi {size} px dan kam bo‘lishi lozim.',
    msgImageResizeError: "Rasm o‘lchamini o‘zgartirib bo‘lmadi.",
    msgImageResizeException:
      "Rasm hajmini o‘zgartirishda xato.<pre>{errors}</pre>",
    msgAjaxError:
      "{operation} amaliyotida xatolik yuz berdi. Iltimos keyinroq qayta urinib ko‘ring!",
    msgAjaxProgressError: "{operation} bajarilmadi",
    msgDuplicateFile:
      '"{name}" nomli "{size} KB" hajmdagi fayl oldin tanlangan. Boshqa faylni tanlashga urinib ko‘ring.',
    msgResumableUploadRetriesExceeded:
      "<b>{file}</b> faylini yuklash uchun <b>{max}</b> marta urinish bekor qilindi! Xato tafsilotlari: <pre>{error}</pre>",
