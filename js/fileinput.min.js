    ...
    cspBuffer: {
      ...
      stash: function (i) {
        ...
        n.find("[style]").each(function (i, r) {
          ...
          e.each(a.domEventsList, function (e, i) {
            var r,
              o,
              l = "on" + i,
              s = n.find("[" + l + "]");
            s.length &&
              ((o = t.parseEventCallback(s.attr(l))),
              s.attr(a.CSP_ATTRIB)
                ? (r = s.attr(a.CSP_ATTRIB))
                : ((r = t.uniqId()), (a.domElementEvents[r] = [])),
              a.domElementEvents[r].push({ name: i + ".csp", handler: o }),
    ...
    (i.prototype = {
        ...
        i.fileManager = {
          ...
          getTotalSize: function () {
            ...
            return t.totalSize
              ? t.totalSize
              : ((t.totalSize = 0),
                e.each(i.fileManager.stack, function (e, i) {
      ...
      _initResumableUpload: function () {
        ...
        if (i.enableResumableUpload) {
          if (
            ...
            !t.hasResumableUploadSupport() && a.fallback !== !1)
          )
            return void a.fallback(i);
          if (!i.uploadUrl && i.enableResumableUpload)
            return i._log(r.noUploadUrl), void (i.enableResumableUpload = !1);
          if (
            ((a.chunkSize = parseFloat(a.chunkSize)),
            a.chunkSize <= 0 || isNaN(a.chunkSize))
          )
            return (
              i._log(r.invalidChunkSize, { chunkSize: a.chunkSize }),
          ...
          (i.resumableManager = {
            init: function (e, t, a) {
              ...
              (r.logs = []),
                ...
                (r.lastProgress = 0),
                i.showPreview &&
                  ((r.$thumb = n.getThumb(e) || null),
                  (r.$progress = r.$btnDelete = null),
                  r.$thumb &&
                    r.$thumb.length &&
                    ((r.$progress = r.$thumb.find(".file-thumb-progress")),
                    (r.$btnDelete = r.$thumb.find(".kv-file-remove")))),
                (r.chunkSize = 1024 * i.resumableUploadOptions.chunkSize),
                (r.chunkCount = r.getTotalChunks());
            },
            setAjaxError: function (e, t, a, n) {
              e.responseJSON &&
                e.responseJSON.error &&
                (a = e.responseJSON.error.toString()),
                n || (rm.error = a),
                i.resumableUploadOptions.showErrorLog &&
                  i._log(r.ajaxError, {
                    status: e.status,
                    error: a,
                    text: e.responseText || "",
            ...
            setProcessed: function (e) {
              ...
              (a.completed = !0),
                ...
                "success" === e
                  ? ((r.uploadedSize += a.file.size),
                    i.showPreview &&
                      (i._setProgress(101, l),
                      i._setThumbStatus(o, "Success"),
                      i._initUploadSuccess(a.chunksProcessed[n].data, o)),
                    i.fileManager.removeFile(n),
                    delete a.chunksProcessed[n],
                    i._raise("fileuploaded", [d.id, d.index, d.fileId]),
                    r.isProcessed() && i._setProgress(101))
                  : "cancel" !== e &&
                    (i.showPreview &&
                      (i._setThumbStatus(o, "Error"),
                      i._setPreviewError(o, !0),
                      i._setProgress(101, l, i.msgProgressError),
                      i._setProgress(101, i.$progress, i.msgProgressError),
                      (i.cancelling = !0)),
                    i.$errorContainer.find(
                      'li[data-file-id="' + d.fileId + '"]'
                    ).length ||
                      ((t = i.msgResumableUploadRetriesExceeded.setTokens({
                        file: a.fileName,
              ...
              e = setInterval(function () {
                ...
                if (
                  ...
                  "new" === o &&
                    ...
                    r.initStats(l),
                    r.stack[l] &&
                      (a.init(l, r.stack[l], r.getIndex(l)),
                      a.processUpload())),
                  !r.isPending(l) && a.completed && (o = "new"),
                  r.isProcessed())
                ) {
                  ...
                  s.length && (t.addCss(s, t.SORT_CSS), i._initSortable()),
                    ...
                    setTimeout(function () {
                      ...
                      e &&
                        ((i.initialPreview = e.content),
                        (i.initialPreviewConfig = e.config),
                        (i.initialPreviewThumbTags = e.tags)),
                        i._raise("filebatchuploadcomplete", [
                          i.initialPreview,
            ...
            uploadResumable: function () {
              ...
              for (t = a.addPool(r.id), e = 0; n > e; e++)
                (r.logs[e] = !(
                  !r.chunksProcessed[r.id] || !r.chunksProcessed[r.id][e]
                )),
                  r.logs[e] || r.pushAjax(e, 0);
              t.run(i.resumableUploadOptions.maxThreads)
                .done(function () {
                  r.setProcessed("success");
                })
                .fail(function () {
                  r.setProcessed(t.cancelled ? "cancel" : "error");
                });
            },
                ...
                ? ((a = new FormData()),
                  ...
                  (o = function (r, n, o) {
                    ...
                    var l = i.uploadParamNames,
                      ...
                      u = [f, p, c, d];
                    r[s] && t.isArray(r[s])
                      ? (c.chunksProcessed[f] || (c.chunksProcessed[f] = {}),
                        e.each(r[s], function (e, t) {
                          (c.logs[t] = !0), (c.chunksProcessed[f][t] = !0);
                        }),
                        (c.chunksProcessed[f].data = r),
                        i._raise("filetestsuccess", u))
                      : i._raise("filetesterror", u),
                      c.uploadResumable();
                  }),
                  (l = function (e, t, r) {
                    (d = i._getOutData(a, e)),
                      i._raise("filetestajaxerror", [f, p, c, d]),
                      c.setAjaxError(e, t, r, !0),
                      c.uploadResumable();
                  }),
                  (s = function () {
                    i._raise("filetestcomplete", [f, p, c, i._getOutData(a)]);
                  }),
                  void i._ajaxSubmit(n, o, s, l, a, f, c.fileIndex, u.testUrl))
                : void c.uploadResumable();
            },
            pushAjax: function (e, t) {
              ...
              o.addTask(o.size() + 1, function (e) {
                var t,
                  a = n.stack.shift();
                (t = a[0]),
                  n.chunksProcessed[n.id] && n.chunksProcessed[n.id][t]
                    ? i._log(r.chunkQueueError, { index: t })
                    : n.sendAjax(t, a[1], e);
              }),
                n.stack.push([e, t]);
            },
            sendAjax: function (e, a, n) {
              ...
              if (!s.chunksProcessed[u] || !s.chunksProcessed[u][e]) {
                if (a > d.maxRetries)
                  return (
                    n.reject("max try reached"), void s.setProcessed("error")
                  );
                var m,
                  h,
                  v,
                  ...
                  (w = function (t, o, d) {
                    ...
                    t.error
                      ? (f.showErrorLog &&
                        ...
                        s.pushAjax(e, a + 1),
                        (s.error = t.error),
                        i._raise("filechunkerror", g))
                      : ((s.logs[t[p]] = !0),
                        s.chunksProcessed[u] || (s.chunksProcessed[u] = {}),
                        (s.chunksProcessed[u][t[p]] = !0),
                        (s.chunksProcessed[u].data = t),
                        n.resolve.call(null, t),
                        i._raise("filechunksuccess", g),
                        s.check());
                  }),
                  (b = function (t, r, o) {
                    return i._isAborted()
                      ? void n.reject("cancelling")
                      : ((h = i._getOutData(m, t)),
                        s.setAjaxError(t, r, o),
                        i._raise("filechunkajaxerror", [u, e, a, l, s, h]),
                        s.pushAjax(e, a + 1),
                        void n.reject("try failed"));
                  }),
                  (_ = function () {
                    i._isAborted() ||
                      i._raise("filechunkcomplete", [
                        u,
                        e,
                        a,
                        l,
      ...
      _initTemplateDefaults: function () {
        ...
        (i =
          ...
          Z._isPdfRendered() &&
            ($ = Z.pdfRendererTemplate.replace(
              "{renderer}",
              Z._encodeURI(Z.pdfRendererUrl)
            )),
          (Z.defaults = {
            layoutTemplates: {
              main1: i,
          ...
          e.each(Z.defaults, function (t, i) {
            return "allowedPreviewTypes" === t
              ? void (
                  void 0 === Z.allowedPreviewTypes &&
                  (Z.allowedPreviewTypes = i)
                )
      ...
      _setZoomContent: function (i, a) {
        ...
        (n = h.attr("data-template") || "generic"),
          ...
          v.data("previewId", m),
          g._handler(v.find(".btn-prev"), "click", function () {
      ...
      _refreshPreview: function () {
        ...
        (i._inputFileCount() || i.isAjaxUpload) &&
          ...
          (i.isAjaxUpload && i.fileManager.count() > 0
            ? ((t = e.extend(!0, {}, i.fileManager.stack)),
              i.fileManager.clear(),
              i._clearFileInput())
            : (t = i.$element[0].files),
      ...
      _uploadSingle: function (i, a, r) {
        ...
        w.enableResumableUpload ||
          ...
          0 === _ ||
            ...
            C.append(w.uploadFileAttr, P.file, E),
      ...
      _uploadBatch: function () {
        ...
        if (0 !== c && p && !s._abort(u)) {
              ...
              (o = s._parseError(g, t, a)),
                ...
                s.showPreview &&
                  (s._getThumbs().each(function () {
                    var t = e(this);
                    t.removeClass("file-uploading"),
                      s.fileManager.getFile(t.attr("data-fileid")) &&
                        s._setPreviewError(t);
                  }),
          ...
          e.each(s.fileManager.stack, function (e, i) {
            t.isEmpty(i.file) ||
              f.append(s.uploadFileAttr, i.file, i.nameFmt || "untitled_" + m),
              m++;
          }),
        ...
        return e.isNumeric(t) && e.isNumeric(o)
          ? ("function" == typeof l
              ...
              : ((a = Math.floor(Math.log(o) / Math.log(1024))),
                ...
                (r = 1 * (o / Math.pow(1024, a)).toFixed(2) + " " + i[a])),
        ...
        if (n.showPreview || (o && o.length)) {
          ...
          if (n.enableResumableUpload) {
            ...
            (m += h),
              ...
              (a = t.round((100 * m) / v)),
              (r.pendingBytes = v - h),
              n._setResumableProgress(a, r, d),
              (l = Math.floor((100 * g) / p)),
              (f.pendingBytes = p - g),
              n._setResumableProgress(l, f);
          } else
            s.setProgress(i, a),
              (o = d && d.length ? d.find(".file-thumb-progress") : null),
      ...
      _validateImageOrientation: function (i, a, r, n, o, l, s, d) {
        var c,
          ...
          f = this,
          g = f.autoOrientImage;
        return f.canOrientImage
          ? void i.css("image-orientation", g ? "from-image" : "none")
          : ((p = t.getZoomSelector(r, " img")),
            (c = g ? f._getExifObj(d) : null),
            (u = c ? c["0th"][piexif.ImageIFD.Orientation] : null)
              ? (f.setImageOrientation(i, e(p), u, f._getFrame(r)),
                f._raise("fileimageoriented", { $img: i, file: a }),
                void f._validateImage(r, n, o, l, s, d, c))
              : void f._validateImage(r, n, o, l, s, d, c));
      },
      ...
      _resetFileStack: function () {
        ...
        t._getThumbs().each(function () {
          ...
          "-1" !== r &&
            -1 !== r &&
            (t.fileManager.getFile(a.attr("data-fileid"))
        ...
        r.fileManager.clearImages(),
          ...
          (a = function (w) {
            ...
            if (U) {
              ...
              if (0 === L.length)
                return (
                  (T = r.msgInvalidFileName.replace(
                    "{name}",
                    t.htmlEncode(t.getFileName(U), "[unknown]")
                  )),
                  void v(T, U, $, w, S)
                );
              if (
                (t.isEmpty(m) ||
                  (Z = new RegExp("\\.(" + m.join("|") + ")$", "i")),
                (y = N.toFixed(2)),
                (r.isAjaxUpload && C.exists(S)) || r._getFrame($, !0).length)
              ) {
                var Y = { id: $, index: w, fileId: S, file: U, files: i };
                return (
                  (T = r.msgDuplicateFile.setTokens({ name: L, size: y })),
                  void (r.isAjaxUpload
              ...
              if (!t.isEmpty(f) && t.isArray(f)) {
                for (x = 0; x < f.length; x += 1)
                  (P = f[x]),
                    (A = p[P]),
                    (W +=
                      A && "function" == typeof A && A(U.type, t.getFileName(U))
                        ? 1
                        : 0);
                if (0 === W)
                  return (
                    (T = r.msgInvalidFileType.setTokens({ name: L, types: q })),
                    void v(T, U, $, w, S)
                  );
              }
              if (
              ...
              if (!r._canPreview(U))
                return (
                  (I = r.isAjaxUpload && r._raise("filebeforeload", [U, w, n])),
                        ...
                        (t.onload = function (e) {
                          return r.isAjaxUpload &&
                            ...
                            ? ((V = !0),
                              ...
                              o.removeClass("file-thumb-loading"),
                              void r.enable())
                            : (r._previewFile(w, U, e, H, s),
                              r._initFileActions(),
                              void G());
                        }),
                        e
                          ? t.readAsText(U, r.textEncoding)
                          : t.readAsDataURL(U);
                    };
                  if (
                    ((s = { name: L, type: U.type }),
          ...
          i.showPreview &&
            i._getThumbs().each(function () {
              ...
              a.removeClass("file-uploading"),
                s.attr("title") === l.indicatorLoadingTitle &&
              ...
              ? ((r.cancelling = !1),
                ...
                0 === o && l
                  ...
                  : ((r.uploadAsync || r.enableResumableUpload) &&
                    ...
                    r.uploadAsync
                      ? ((i = 0),
                        void e.each(n.stack, function (e) {
