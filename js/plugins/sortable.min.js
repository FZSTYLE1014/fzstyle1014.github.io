...
!(function (t, e) {
  ...
  function Rt(t, e) {
    ...
    (this.nativeDraggable = !e.forceFallback && xt),
      ...
      e.supportPointer
        ? u(t, "pointerdown", this._onTapStart)
  ...
  (Rt.prototype = {
        ...
        if (
          ...
          !z &&
            !(
              ...
              t.disabled ||
              s.isContentEditable ||
              ((l = P(l, t.draggable, o, !1)) && l.animated) ||
              Z === l
            ))
        ) {
      ...
      if (n && !z && n.parentNode === r) {
        ...
        if (
          ...
          u(l, "mouseup", i._disableDelayedDrag),
            ...
            a.supportPointer &&
              u(l, "pointermove", i._delayedDragTouchMoveHandler),
      ...
      (e = e || ("touch" == t.pointerType && t)),
        !this.nativeDraggable || e
          ? this.options.supportPointer
            ? u(document, "pointermove", this._onTouchMove)
            : u(document, e ? "touchmove" : "mousemove", this._onTouchMove)
          : (u(z, "dragend", this), u(q, "dragstart", this._onDragStart));
      try {
        document.selection
          ? Ht(function () {
        ...
        if (
          ...
          if (
            ...
            if (
              ...
              return O(), l.appendChild(z), (G = l), N(), A(!0);
    ...
    _onDrop: function (t) {
      ...
      (tt = F(z)),
        ...
        Rt.eventCanceled ||
          ...
          this.nativeDraggable &&
            (d(document, "drop", this), d(e, "dragstart", this._onDragStart)),
          this._offMoveEvents(),
          this._offUpEvents(),
          ...
          t &&
            ...
            z &&
              (this.nativeDraggable && d(z, "dragend", this),
              Yt(z),
              (z.style["will-change"] = ""),
              dt &&
                !vt &&
    ...
    destroy: function () {
      ...
      (t[j] = null),
        ...
        this.nativeDraggable &&
          (d(t, "dragover", this), d(t, "dragenter", this)),
    ...
    _showClone: function (t) {
      if ("clone" === t.lastPutMode) {
        if ($) {
          ...
          q.contains(z) && !this.options.group.revertClone
            ? q.insertBefore(Q, z)
            : V
            ? q.insertBefore(Q, V)
            : q.appendChild(Q),
          ...
          (t.prototype = {
            dragStarted: function (t) {
              ...
              this.sortable.nativeDraggable
                ? u(document, "dragover", this._handleAutoScroll)
                : this.options.supportPointer
                ? u(document, "pointermove", this._handleFallbackAutoScroll)
                : e.touches
                ? u(document, "touchmove", this._handleFallbackAutoScroll)
                : u(document, "mousemove", this._handleFallbackAutoScroll);
            },
      ...
      new (function () {
        function t(o) {
          ...
          o.options.supportPointer
            ? u(document, "pointerup", this._deselectMultiDrag)
            : (u(document, "mouseup", this._deselectMultiDrag),
