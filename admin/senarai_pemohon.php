                    ...
                    <div class="col-12 mt-4">
                        <div class="card">
                            <div class="card-body collapse show">
                                <h4 class="card-title">Senarai Pemohon</h4> </br>
							...
							?>
                              ...
                              { ?>
                                <div class="card text-white bg-dark">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title text-white"><?php echo $row['nama_jawatan']; ?><p
                                                class="card-text">
                                                Taraf : <?php echo $row['taraf_jawatan']; ?> </br>
                                                Kelayakan : <?php echo $row['kelayakan_jawatan']; ?> </br>
                                                <?php echo date("d M Y", strtotime($row['tarikh_buka'])); ?> -
                                                <?php echo date("d M Y", strtotime($row['tarikh_tutup'])); ?></br>
                                            </p>
                                            <a href="senarai_pemohon2.php?id=<?php echo $row['id_jawatan']; ?>"
                                                class="btn btn-primary">Senarai Pemohon</a>
