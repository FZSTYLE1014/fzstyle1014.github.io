...
<body>
    ...
    opacity: 1;"><i data-feather="list" class="feather-icon"></i><span class="hide-menu">Senarai Jawatan</span></a>
                        </li>
                        <li class="list-divider"></li>
                            ...
                            <div class="card-body collapse show">
                                ...
                                <p class="card-text">
                                    ...
                                    <div class="mt-4 activity">
                                        ...
                                        <?php 
									$query = "SELECT * FROM `jawatan_kosong` order by tarikh_tutup desc";  
								 ...
								 ?>
									...
									?>
                                        <div class="d-flex align-items-start border-left-line pb-3">
                                            <div>
                                                <?php if ( ( date("Y-m-d") >= date("Y-m-d", strtotime($row['tarikh_buka'])) ) && ( date("Y-m-d") <= date("Y-m-d", strtotime($row['tarikh_tutup'])) ) ) {?>
                                                <a href="javascript:void(0)"
                                                    class="btn btn-danger btn-circle mb-2 btn-item"
                                                    style="background-color: #14c02a;border-color: #14c02a;">
                                                    <i data-feather="file-text"></i>
                                                </a>
                                                <?php } 
                                          else if ( ( date("Y-m-d") <= date("Y-m-d", strtotime($row['tarikh_buka'])) ) ) { ?>
                                                <a href="javascript:void(0)"
                                                    class="btn btn-danger btn-circle mb-2 btn-item"
                                                    style="background-color: #b8c3d5;border-color: #b8c3d5;">
                                                    <i data-feather="file-text"></i>
                                                </a>
                                                <?php } else { ?>
                                                <a href="javascript:void(0)"
                                                    class="btn btn-danger btn-circle mb-2 btn-item"
                                                    style="background-color: #f41211;border-color: #f41211;">
                                                    <i data-feather="file-text"></i>
                                                </a>
                                                <?php }?>
                                            </div>
                                            <div class="ml-3 mt-2">
                                                <h5 class="text-dark font-weight-medium mb-2">
                                                    <?php echo $row['nama_jawatan']; ?></h5>
                                                <h7 class="text-dark font-weight-medium mb-3">
                                                    <?php echo $row['penerangan_jawatan']; ?></h7>
                                                <p class="font-14 mb-2 text-muted">Taraf:
                                                    <?php echo $row['taraf_jawatan']; ?> <br>
                                                    Kelayakan: <?php echo $row['kelayakan_jawatan']; ?> <br>
                                                    <?php echo date("d M Y", strtotime($row['tarikh_buka'])); ?> -
                                                    <?php echo date("d M Y", strtotime($row['tarikh_tutup'])); ?></p>
                                                <span
                                                    class="font-weight-light font-14 text-muted"><?php echo $row['created']; ?></span>
                                            </div>
                                        </div>
                                        <?php }?>
                                        <!-- LOOP -->
