...
$nama_jawatan = mysqli_real_escape_string($link, $_REQUEST['nama']);
$taraf_jawatan = mysqli_real_escape_string($link, $_REQUEST['taraf']);
$kelayakan = mysqli_real_escape_string($link, $_REQUEST['kelayakan']);
$tarikh_buka = mysqli_real_escape_string($link, $_REQUEST['tarikh_buka']);
$tarikh_tutup = mysqli_real_escape_string($link, $_REQUEST['tarikh_tutup']);
...
<body>
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Taraf</label>
                                                    <select class="form-control" name="taraf" id="taraf">
                                                        <option>Pilih..</option>
                                                        <option>Tetap</option>
    ...
    <?php 
		...
		$sql2 = "INSERT INTO jawatan_kosong (nama_jawatan, taraf_jawatan, kelayakan_jawatan, tarikh_buka, tarikh_tutup, created) VALUES ('$nama_jawatan', '$taraf_jawatan', '$kelayakan', '$tarikh_buka', '$tarikh_tutup', '$created_at')";
		if(mysqli_query($link, $sql2)){ ?>
    <script>
        swal({
                text: "Jawatan Berjaya Di Tambah",
                icon: "success",
                dangerMode: false,
            ...
            .then((willDelete) => {
                if (willDelete) {
                    window.location = "tambah_jawatan.php";
                }
            });
    </script>
    <?php    
