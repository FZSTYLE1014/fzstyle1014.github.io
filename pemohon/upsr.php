    ...
    <div class="row">
      ...
      <div class="col-9 offset-3" id="main" style="background-color:3ACFBE">
        ...
        <ul class="nav nav-tabs">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="upsr.php">UPSR</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" text-color="FFFFFF" href="pmr.php">PMR/SRP/PT3</a>
          </li>
          <li class="nav-item">
        ...
        <div class="text-center">
          <br />
          <h2 style="color:FFFFFF"><b>KEPUTUSAN UPSR</b></h2>
        </div>
        ...
        <form class="col-sm-12 shadow-lg p-3  mb-12 bg-white rounded" enctype="multipart/form-data" action="upsr.php"
          ...
          <div class="row">
            <div class="col-md-6">
              Tahun:
              <select name="tahun_pmr" id="tahun_upsr" class="form-control" style="width: 250px;">
            ...
            <div class="col-md-6">
              ...
              <select name="matapelajaran_upsr" id="subjek_upsr" class="form-control">
                <option value="" selected disabled>--Sila Pilih--</option>
                ...
                <option value="KH BERSEPADU-KEMAHIRAN TEKNIKAL">KH BERSEPADU(KEMAHIRAN TEKNIKAL)</option>
            ...
            <div class="col-md-6">
              Gred:
              <select name="gred_upsr" id="gred_upsr" class="form-control" style="width: 250px;">
                <option value="" selected disabled>--Sila Pilih--</option>
          ...
          <div class="container">
            ...
            <script>
              ...
              function productDisplay(ctl) {
                ...
                $("#tahun_upsr").val($(cols[1]).text());
                $("#subjek_upsr").val($(cols[2]).text());
                $("#gred_upsr").val($(cols[3]).text());
              ...
              function productBuildTableRow() {
                var ret =
                  ...
                  "</button>" +
                  "</td>" +
                  "<td>" + $("#tahun_upsr").val() + "</td>" +
                  "<td>" + $("#subjek_upsr").val() + "</td>" +
                  "<td>" + $("#gred_upsr").val() + "</td>" +
                  "<td>" +
                  "<button type='button' " +
