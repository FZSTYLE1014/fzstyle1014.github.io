...
<body>
  <header id="header" class="fixed-top bg-white ">
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          <li class="text-dark active "><a href="index.php">Home</a></li>
          <li><a class="text-dark" href="login.php">Log Masuk</a></li>
          <li><a class="text-dark" href="register.php">Pendaftaran Baru</a></li>
        </ul>
      </nav>
  ...
  <section id="hero">
	...
	?>
    <div class="carousel-item active" style="background-image: url(assets/front.png)">
        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-6">
              <!-- <div class="card">
                  <div class="card-body"> -->
              <img src="assets\logo.png" width="300" height="150" /><br />
              <!-- </div>
                </div> -->
            </div>
            <div class="col-sm-6">
              <!-- <div class="card">
                  <div class="card-body"> -->
              <img src="assets\e.png" width="430" />
              <!-- </div>
                </div> -->
            </div>
          </div>
          ...
          <p>Suruhanjaya Integriti Agensi Penguatkuasaan merupakan sebuah agensi Badan Berkanun Persekutuan yang
            ...
            Penguatkuasaan. Suruhanjaya mempelawa warganegara Malaysia yang berintegriti dan berkelayakan bagi mengisi
            kekosongan jawatan di EAIC.</p>
        </div>
      </div>
    </div>
    </div>
...
?>
            ...
            <div class="col-md-12 text-center">
              <br /><br /><a href="register.php" type="button" class="btn btn-success">Daftar Sekarang!
